...
RgbaAddressControl::updateLedAddressConfig(LedConfigData newConfigData) {
...
RgbaAddressControl::updatePowerState() {
...
RgbaAddressControl::applyLedInternalConfig() {
...
RgbaAddressControl::tick() {
  if (millis() - lastTimeUpdateLed >= thisdelay) {
    switch (ledConfigData.mode) {
      case 1: break;                              // пазуа
